    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dominio_login', models.CharField(blank=True, help_text='URL - exe: seudominio.com.br/admin', max_length=200, verbose_name='Acesso ao Admin')),
                ('login', models.CharField(blank=True, max_length=30, verbose_name='Login')),
