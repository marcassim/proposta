        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "valor",
                    models.DecimalField(
                        decimal_places=2, max_digits=8, verbose_name="Valor a pagar"
                    ),
                ),
                (
                    "situacao",
                ...
                (
                    "login",
                    models.CharField(blank=True, max_length=30, verbose_name="Login"),
                ),
                (
                    "senha",
                    models.CharField(blank=True, max_length=30, verbose_name="Senha"),
                ),
                (
                    "cliente",
                    models.ForeignKey(
